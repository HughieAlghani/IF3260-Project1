...
window.addEventListener("load", () => {
  ...
  // Rectangle Global Var Component
  var rectangle_Coor = [];
  ...
  canvas.addEventListener('mousedown', function(e) {
      if (document.getElementById("rectangle").checked == true) {  
          pos0 = pointer(e);
          rectangle_Coor.push(pos0.x);
          rectangle_Coor.push(pos0.y);
          rectangle_Count += 1;
          click = true;
      } 
  ...
  canvas.addEventListener('mousemove', function(e) {
    if (document.getElementById("rectangle").checked == true) {
      if (click) {
          ...
          rectangle_Coor.push(pos1.x);
          rectangle_Coor.push(pos0.y)
          
          rectangle_Coor.push(pos0.x);
          rectangle_Coor.push(pos1.y);
